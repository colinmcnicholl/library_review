---
title: A Library Users Observations On The Libraries And Archives Review Phase 1 Cabinet
  Report
author: "Colin McNicholl"
date: "6 June 2025"
output:
...
Page 7 Table 1 Total number of in person issues 2018-19 213,924
...
Page 7 Table 1 Total core event & programme attendance 2018-19 15,608
...
Page 7 Table 1 Total number of computer hours used 2019-20 16,624 
...
Page 7 Table 1 Total core event & programme attendance 2019-20 19,454
...
Page 7 Table 1 Total core event & programme attendance 2022-23 16,619
...
Page 7 Table 1 Total number of physical visits 2023-24 146,019
...
Page 7 Table 1 Total core event & programme attendance 2023-24 18,521
...
**The raw data from which Table 1 and Table 2 were created are made publically available so that these tables can be reproduced.**
...
p1 <- ggplot(data = visits_dat, aes(x=year2,y=count,color=branch)) +
    ...
    labs(
        title = paste("Increase in total number of physical visits",
                      "for Waltham"),
        subtitle = paste("Decreases 2018 vs 2023 for Immingham, Grimsby,",
...
p2 <- ggplot(data = issues_dat, aes(x=year2,y=count,color=branch)) +
    ...
    annotate("text",x=as.Date(c("2020-05-15","2020-12-10","2021-02-25")),
             ...
             color="blue",size=4,fontface="bold") +
    labs(
        title = paste("Little change in number of physical issues",
                      "for Immingham and Waltham"),
        subtitle = paste("Decreases 2018 vs 2023 for Grimsby, Cleethorpes,",
...
It can be clearly seen that **there was no large decrease in the total number of pyhsical visits pre vs post-covid for Waltham branch.  There are two full years of missing data.  Lock-down duration is a small proportion of two year period.**  Why the difference?  Work should be undertaken to explore this in detail.  As a user of Waltham, Grimsby, Cleethorpes and very occasionally Immingham branches I believe that Grimsby and Cleethorpes (and possibly Immingham ?  The current Lincs Inspire website suggests newspapers are provided at Immingham) offered a selection of daily national newspapers pre-covid but not post-covid.  **Was there a silent decision to not renew the newspaper order post covid or was this a considered policy decison?**  Either way, I strongly suspect it is a contributor to the decline in physical visits at Grimsby and Cleethorpes.  Waltham did not offer daily national newspapers pre-covid.  I consider it **innapropriate to use the term trend in the presentation in Figure 4 given the sparse number of data points and the total ommission of data for a 2 year period within the interval presented**  I recommend **data for each year from whenever Lincs Inpire took on management of the 4 branches be made available.**
